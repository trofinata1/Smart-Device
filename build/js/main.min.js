...
/* harmony import */ var _modules_hidden_blocks_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/hidden-blocks.js */ "./js/modules/hidden-blocks.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.innerWidth < 768 && document.querySelector('.accordion-trigger')) {
    ...
    var contents = document.querySelectorAll('.accordion-trigger__content');
    ...
    Object(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_2__["onAccordionClick"])();
  }
  ...
  if (window.innerWidth < 768 && document.querySelector('#hidden-about-block')) {
    var hiddenAboutBlock = document.querySelector('#hidden-about-block');
  ...
  Object(_modules_hidden_blocks_js__WEBPACK_IMPORTED_MODULE_3__["onAboutButtonClick"])();
  ...
  if (document.querySelector('.accordion-trigger')) {
    ...
    accordionTriggers.forEach(function (trigger) {
      trigger.addEventListener('click', function () {
        ...
        var content = document.querySelector('.accordion-trigger__content--with-js[data-accordion="' + id + '"]');
        var activeTrigger = document.querySelector('.accordion-trigger--with-js.active');
        var activeContent = document.querySelector('.accordion-trigger__content--with-js.active');
...
/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ "./js/modules/api.js");
/* harmony import */ var _show_error_or_success_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./show-error-or-success.js */ "./js/modules/show-error-or-success.js");
...
var onFormSubmit = function onFormSubmit(evt) {
  ...
  if (inputName.checkValidity() && inputTel.checkValidity()) {
    blockSubmitButton();
    Object(_api_js__WEBPACK_IMPORTED_MODULE_0__["sendData"])(SENDING_DATA_URL, _show_error_or_success_js__WEBPACK_IMPORTED_MODULE_1__["onSuccessSubmit"], _show_error_or_success_js__WEBPACK_IMPORTED_MODULE_1__["onErrorSubmit"], formData);
...
var onAboutButtonClick = function onAboutButtonClick() {
  if (document.querySelector('.about__button')) {
    ...
    var aboutBlocks = about.querySelectorAll('.hidden');
...
/* harmony import */ var _form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form.js */ "./js/modules/form.js");


var onSuccessSubmit = function onSuccessSubmit() {
  Object(_popup_js__WEBPACK_IMPORTED_MODULE_0__["showPopup"])('[data-modal="success"]');
  Object(_form_js__WEBPACK_IMPORTED_MODULE_1__["unblockSubmitButton"])();
  Object(_form_js__WEBPACK_IMPORTED_MODULE_1__["onFormReset"])();
};
var onErrorSubmit = function onErrorSubmit() {
  Object(_popup_js__WEBPACK_IMPORTED_MODULE_0__["showPopup"])('[data-modal="error"]');
  Object(_form_js__WEBPACK_IMPORTED_MODULE_1__["unblockSubmitButton"])();
};
